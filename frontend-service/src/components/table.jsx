        ...
        <table class="w-full mt-4 text-left table-auto min-w-max">
          <thead>
            <tr>
              ...
              <th class="p-4 border-y border-blue-gray-100 bg-blue-gray-50/50">
                <p class="block text-sm antialiased font-normal leading-none text-blue-gray-900 opacity-70"></p>
              </th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td class="p-4 border-b border-blue-gray-50">
                <div class="w-max">
                  <div class="relative grid items-center px-2 py-1 text-xs font-bold uppercase rounded-md select-none whitespace-nowrap bg-blue-gray-500/20 text-blue-gray-900">
